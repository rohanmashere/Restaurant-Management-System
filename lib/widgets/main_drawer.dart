import 'dart:io';
import 'package:delight_corner/screens/bill_history_screen.dart';
import 'package:delight_corner/screens/manager_login_screen.dart';
import 'package:delight_corner/screens/manager_menu_screen.dart';
import 'package:delight_corner/screens/manager_profile_screen.dart';
import 'package:delight_corner/screens/manager_table_screen.dart';
import 'package:delight_corner/screens/manager_waiter_screen.dart';
...
class MainDrawer extends StatelessWidget {
  ...
  void profile(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (ctx) => ManagerProfileScreen(),
      ),
    );
  }
  ...
  void table(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (ctx) => ManagerTableScreen(),
      ),
    );
  }
  ...
  void waiter(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (ctx) => ManagerWaiterScreen(),
      ),
    );
  }
