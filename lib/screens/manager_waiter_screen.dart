...
import 'package:delight_corner/screens/waiter_add_screen.dart';
import 'package:delight_corner/screens/manager_waiter_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<Waiter>>(
        stream: getUserWaiters(), // Use the stream for real-time updates
