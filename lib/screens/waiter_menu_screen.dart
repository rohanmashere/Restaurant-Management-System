...
import 'package:delight_corner/screens/waiter_checkout_screen.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class WaiterMenuScreen extends StatefulWidget {
  const WaiterMenuScreen(
      {super.key, required this.username, required this.table});
...
class WaiterMenuScreenState extends State<WaiterMenuScreen> {
  ...
  void addToOrder(
      String table, String category, Map<String, dynamic> item) async {
    try {
      ...
      final tableOrders =
          List<Map<String, dynamic>>.from(currentAddMenu[table] ?? []);
      final itemIndex = tableOrders.indexWhere((order) =>
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: StreamBuilder<String?>(
          stream: getUserIdByUsernameStream(
            widget.username,
          ),
