...
import 'package:delight_corner/screens/menu_add_screen.dart';
...
class ManagerMenuScreenState extends State<ManagerMenuScreen> {
  ...
  void removeMenuItem(String category, String subcategory, String itemName,
      ...
      body: GestureDetector(
        ...
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            return ListView(
              children: menuData.keys.where((category) {
                ...
                return ExpansionTile(
                  ...
                  children: subcategories.keys.map((subcat) {
                    final items =
                        List<Map<String, dynamic>>.from(subcategories[subcat]);
                    items.sort((a, b) =>
                    ...
                    return ExpansionTile(
                      ...
                      children: items.where((item) {
                        ...
                        return _searchQuery.isEmpty ||
                            ...
                            itemPrice.toLowerCase().contains(_searchQuery);
                      }).map((item) {
                        final itemName = item['name'] ?? 'Unknown';
