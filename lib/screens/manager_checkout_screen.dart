...
class ManagerCheckoutScreenState extends State<ManagerCheckoutScreen> {
  ...
  Future<Map<String, dynamic>> fetchOrderDetails(
      String userId, String table) async {
    try {
      final userDocRef =
      ...
      if (userDocSnapshot.exists) {
        ...
        final tableOrders =
            List<Map<String, dynamic>>.from(addMenu[table] ?? []);
        final tableTotalBill = totalBill[table] ?? 0.0;

        return {
          'orders': tableOrders,
          'total_bill': tableTotalBill,
        };
      } else {
    ...
    try {
      ...
      return await FirebaseFirestore.instance
        ...
        if (!docSnapshot.exists) {
          ...
          transaction
              .update(docRef, {'current_invoice_number': newInvoiceNumber});
        }
    ...
    try {
      ...
      await FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        if (userDocSnapshot.exists) {
          ...
          Map<String, dynamic> updatedAddMenu =
              Map.from(currentData['add_menu'] ?? {});
          Map<String, dynamic> updatedTotalBill =
              Map.from(currentData['total_bill'] ?? {});
  ...
  Future<void> storeBillFor5Minutes(
      String invoiceNumber, double totalBill) async {
        ...
        children: [
          StreamBuilder<DocumentSnapshot>(
            ...
            builder: (context, orderSnapshot) {
              ...
              final totalBill = data['total_bill'][widget.table] ?? 0.0;
                ...
                onPressed: isGeneratingBill
                    ...
                    : () async {
                        ...
                        if (orderDetails['total_bill'] == 0) {
                          ...
                          await generateAndViewBill(orderDetails,
                              restaurantName, address, mobileNo, email);
                          setState(() {});
                        }
                      },
