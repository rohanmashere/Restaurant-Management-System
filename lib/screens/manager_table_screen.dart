...
import 'package:delight_corner/screens/table_add_screen.dart';
...
class ManagerTableScreenState extends ConsumerState<ManagerTableScreen> {
  ...
  void addTable(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (ctx) => TableAddScreen(onAdd: onAddTable),
      ),
    );
  }
    ...
    try {
      ...
      if (tables.contains(tableName)) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Table removed successfully'),
          ),
        );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Error removing table: ${e.toString()}'),
        ),
      );
    }
  }
